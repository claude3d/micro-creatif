...
const TIME_TRAVEL_LANGUAGES = {
  "en": {
    ...
    "strings": {
      ...
      "videos.note": "Both videos were recorded directly with the standard Time Travel Sky app — no special version was used. You can create animations like these yourself with the app’s normal controls.",
  ...
  "fr": {
    ...
    "strings": {
      ...
      "videos.note": "Ces deux vidéos ont été enregistrées directement avec la version standard de Time Travel Sky — aucune version spéciale n’a été utilisée. Vous pouvez créer vous-même des animations comme celles-ci avec les commandes normales de l’app.",
  ...
  "vi": {
    ...
    "strings": {
      ...
      "videos.note": "Cả hai video đều được ghi trực tiếp bằng phiên bản tiêu chuẩn của Time Travel Sky — không sử dụng phiên bản đặc biệt nào. Bạn có thể tự tạo những hoạt ảnh như thế này bằng các điều khiển thông thường của ứng dụng.",
  ...
  "ja": {
    ...
    "strings": {
      ...
      "videos.note": "どちらの動画も通常版のTime Travel Skyをそのまま使って録画したもので、特別なバージョンは使用していません。アプリの通常の操作だけで、同じようなアニメーションを自分で作成できます。",
  ...
  "zh-Hans": {
    ...
    "strings": {
      ...
      "videos.note": "这两段视频都是直接使用标准版 Time Travel Sky 录制的——没有使用任何特殊版本。你也可以使用应用中的普通控制功能制作同样的动画。",
  ...
  "zh-Hant": {
    ...
    "strings": {
      ...
      "videos.note": "這兩段影片都是直接使用標準版 Time Travel Sky 錄製的——沒有使用任何特殊版本。你也可以使用 app 的一般控制功能製作同樣的動畫。",
  ...
  "es": {
    ...
    "strings": {
      ...
      "videos.note": "Los dos vídeos se grabaron directamente con la versión estándar de Time Travel Sky; no se utilizó ninguna versión especial. Puedes crear tú mismo animaciones como estas con los controles normales de la app.",
  ...
  "de": {
    ...
    "strings": {
      ...
      "videos.note": "Beide Videos wurden direkt mit der normalen Version von Time Travel Sky aufgenommen — es wurde keine spezielle Version verwendet. Mit den normalen Bedienelementen der App kannst du solche Animationen selbst erstellen.",
  ...
  "ar": {
    ...
    "strings": {
      ...
      "videos.note": "تم تسجيل كلا الفيديوهين مباشرة باستخدام النسخة العادية من Time Travel Sky — من دون أي نسخة خاصة. يمكنك إنشاء رسوم متحركة مماثلة بنفسك باستخدام أدوات التحكم العادية في التطبيق.",
  ...
  "ko": {
    ...
    "strings": {
      ...
      "videos.note": "두 동영상 모두 특별한 버전이 아닌 표준 Time Travel Sky 앱에서 직접 녹화했습니다. 앱의 일반 조작만으로도 이런 애니메이션을 직접 만들 수 있습니다.",
